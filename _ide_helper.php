...
')
     ...
     */
         ...
         *
         *
         * @see \Mtownsend\CollectionXml\Providers\CollectionXmlServiceProvider::boot()
         * @param mixed $root
         * @static
         */
        public static function toXml($root = '')
        {
                        return \Illuminate\Support\Collection::toXml($root);
        }
                    /**
         *
         *
         * @see \Mtownsend\CollectionXml\Providers\CollectionXmlServiceProvider::boot()
         * @param mixed $root
         * @param mixed $soapRoot
         * @param mixed $fullUrl
         * @param array $options
         * @static
         */
        public static function toSoapXml($root, $soapRoot, $fullUrl, $options = [])
        {
                        return \Illuminate\Support\Collection::toSoapXml($root, $soapRoot, $fullUrl, $options);
        }
     ...
     */
         ...
         * @static
         */
        public static function getIPBasedCountry()
        {
                        /** @var \Mpociot\VatCalculator\VatCalculator $instance */
                        return $instance->getIPBasedCountry();
        }
                    /**
