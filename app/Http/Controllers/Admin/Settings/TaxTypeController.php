...
use App\Http\Requests\Settings\TaxType\Store;
use App\Http\Requests\Settings\TaxType\Update;
use Gate;
...
class TaxTypeController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('admin.settings.tax_type.index', compact('tax_types'));
    }
    ...
    public function create(Request $request)
    {
        ...
        return view('admin.settings.tax_type.create', compact('tax_type'));
    }
    ...
    public function store(Store $request)
    {
        ...
        session()->flash('alert-success', __('global.tax_type_added'));
     ...
     * Update the Tax Type
     *
     * @param \App\Http\Requests\Settings\TaxType\Update $request
     *
     * @return \Illuminate\Routing\Redirector|\Illuminate\Http\RedirectResponse
     */
    ...
    public function delete(Request $request)
    {
        ...
        if ($tax_type->taxes() && $tax_type->taxes()->count() > 0) {
            session()->flash('alert-error', __('global.tax_type_is_in_use'));
            return redirect()->route('settings.tax_types');
        }
        ...
        session()->flash('alert-success', __('global.tax_type_deleted'));
        return redirect()->route('settings.tax_types');
    }
}
