    ...
    <div class="row">
        ...
        <div class="col-xl-10 col-sm-9">
            <div class="card">
                ...
                <div class="card-body">
                    <!-- Nav tabs -->
                    <ul class="nav nav-tabs nav-tabs-custom nav-justified" id="productSettingsTabs" role="tablist">
                        <li class="nav-item">
                                ...
                                <form action="{{ route('settings.product.update') }}" method="POST">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <div class="custom-control custom-switch">
                                                    <input type="checkbox" name="discount_per_item" id="discount_per_item"
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <div class="custom-control custom-switch">
                                                    <input type="checkbox" name="sales_locations" id="sales_locations"
                                                           {{ $currentCompany->getSetting('sales_locations') ? 'checked' : '' }}
                                                           class="custom-control-input" onchange="toggleLocationsTab()">
                        ...
                        <div class="tab-pane fade" id="units" role="tabpanel" aria-labelledby="units-tab">
                            <div class="p-3">
                                <div class="row mb-3">
                                    ...
                                    <div class="col-auto">
                                        @can('settings_create')
                                            <a href="{{ route('admin.packagetype.create') }}" class="btn btn-sm btn-primary">
                                ...
                                <div id="locations-content">
                                    @if($currentCompany->getSetting('sales_locations'))
                                        <div class="row mb-3">
                                            <div class="col">
                                                ...
                                                <small class="text-muted">{{ __('messages.manage_sales_locations') }}</small>
                                            </div>
                                            <div class="col-auto">
                                                @can('settings_create')
                                    ...
                                    @else
                                        <div class="text-center py-5">
                                            <div class="mb-3">
                                                <i data-feather="map-pin" class="align-self-center" style="width: 48px; height: 48px; color: #ccc;"></i>
                                            </div>
                                            <h5 class="text-muted">{{ __('global.locations_disabled') }}</h5>
                                            <p class="text-muted">{{ __('messages.enable_locations_to_manage') }}</p>
                                            <button type="button" class="btn btn-outline-primary" onclick="enableLocations()">
                                                <i data-feather="toggle-right" class="align-self-center icon-xs me-1"></i>
