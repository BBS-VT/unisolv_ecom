    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="page-title-box">
                <div class="row">
                    <div class="col">
                        <h4 class="page-title">{{ trans('cruds.customerCategory.title') }}</h4>
                    </div>
            ...
            <div class="card">
                <div class="card-body">
                    <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0;">
                        ...
                        <tr>
                            <th width="10"></th>
                            <th>{{ trans('cruds.customerCategory.fields.category_name') }}</th>
                            <th>{{ trans('cruds.customerCategory.fields.valid_from') }}</th>
                            <th>{{ trans('cruds.customerCategory.fields.valid_to') }}</th>
                            <th>&nbsp;</th>
                        </tr>
                        </thead>
                        <tbody>
                            @foreach($customerCategories as $key => $customerCategory)
                                <tr data-entry-id="{{ $customerCategory->id }}">
                                    ...
                                    <td>
                                        {{ \Carbon\Carbon::parse($customerCategory->ValidFrom ?? '')->format('d/m/Y') }}
                                    </td>
                                    <td>
                                        {{ \Carbon\Carbon::parse($customerCategory->ValidTo ?? '')->format('d/m/Y') }}
                                    </td>
                                    <td>
