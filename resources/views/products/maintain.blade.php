    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                    ...
                    <div class="row">
                        <div class="col">
                            <h4 class="card-title">
                                ...
                                @elseif( $title == 'edit')
                                    {{ trans('global.edit') }} {{ trans('cruds.product.title_singular') }} - <span class="text-danger">{{ $product->StockItemName }}</span>
                                @endif
                            </h4>
                        </div>
                ...
                <div class="card-body">
                    <form name="productForm" id="ProductForm" @if(empty($productdata['id'])) action="{{ route('products.maintain') }}"
                          @else action="{{ url('products/maintain/'.$productdata['id']) }}" @endif method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-sm-2">
                                        <div class="form-group">
                                            ...
                                            <input id="StockCode" class="form-control {{ $errors->has('StockCode') ? 'is-invalid' : '' }}"
                                                   name="StockCode" tabindex=1 type="text" @if(!empty($productdata['StockCode'])) value="{{ $productdata['StockCode'] }}"
                                                   @else value="{{ old('StockCode', '') }}" @endif required>
                                    ...
                                    <div class="col-md-10">
                                        <div class="form-group">
                                            ...
                                            <input id="StockItemName" class="form-control {{ $errors->has('StockItemName') ? 'is-invalid' : '' }}"
                                                   name="StockItemName" tabindex=2 type="text" @if(!empty($productdata['StockItemName'])) value="{{ $productdata['StockItemName'] }}"
                                                   @else value="{{ old('StockItemName', '') }}" @endif required>
                        ...
                        <div class="row">
                            <div class="col-sm-2">
                                <div class="form-group">
                                    ...
                                    <input id="Size" class="form-control {{ $errors->has('Size') ? 'is-invalid' : '' }}" type="text"
                                           name="Size" tabindex=6 @if(!empty($productdata['Size'])) value="{{ $productdata['Size'] }}"
                            ...
                            <div class="col-sm-2">
                                <div class="form-group">
                                    ...
                                    <option class="form-control mb-3 select2 {{ $errors->has('salesunits') ? 'is-invalid' : '' }}" name="salesunits[]" id="salesunits">
                            ...
                            <div class="col-sm-2">
                                <div class="form-group">
                                    ...
                                    <input id="Packsize" class="form-control {{ $errors->has('Packsize') ? 'is-invalid' : '' }}" type="text"
                                           name="Packsize" tabindex=8 @if(!empty($productdata['Packsize'])) value="{{ $productdata['Packsize'] }}"
                                           @else value="{{ old('Packsize', '') }}" @endif>
                            ...
                            <div class="col-sm-2">
                                <div class="form-group">
                                    ...
                                    <input id="Barcode" class="form-control {{ $errors->has('Barcode') ? 'is-invalid' : '' }}" type="text"
                                           name="Barcode" tabindex="9" @if(!empty($productdata['Barcode'])) value="{{ $productdata['Barcode'] }}"
                                           @else value="{{ old('Barcode', '') }}" @endif>
                        ...
                        <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-sm-2">
                                        <div class="form-group">
                                            ...
                                            <input id="TaxRateID" class="form-control {{ $errors->has('TaxRateID') ? 'is-invalid' : '' }}" type="text"
                                                   name="TaxRateID" tabindex=10 @if(!empty($productdata['TaxRateID'])) value="{{ $productdata['TaxRateID'] }}"
                                                   @else value="{{ old('TaxRateID', '1') }}" @endif>
                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            ...
                                            <input id="CostPrice" class="form-control text-center {{ $errors->has('CostPrice') ? 'is-invalid' : '' }}" type="number"
                                                   name="CostPrice" tabindex=11 @if(!empty($productdata['CostPrice'])) value="{{ $productdata['CostPrice'] }}"
                                                   @else value="{{ old('CostPrice', '') }}" @endif step="0.01">
                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            ...
                                            <input id="DiscountPercentage" class="form-control text-center {{ $errors->has('DiscountPercentage') ? 'is-invalid' : '' }}" type="text"
                                                   name="DiscountPercentage" tabindex=12 @if(!empty($productdata['DiscountPercentage'])) value="{{ $productdata['DiscountPercentage'] }}"
                                                   @else value="{{ old('DiscountPercentage', '') }}" @endif>
                                ...
                                <div class="row">
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            ...
                                            <input id="SellingPrice" class="form-control text-center {{ $errors->has('SellingPrice') ? 'is-invalid' : '' }}" type="number"
                                                   name="SellingPrice" tabindex=13 @if(!empty($productdata['SellingPrice'])) value="{{ $productdata['SellingPrice'] }}"
                                                   @else value="{{ old('SellingPrice', '') }}" @endif step="0.01" required>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <textarea id="MarketingComments" class="form-control text-justify {{ $errors->has('MarketingComments') ? 'is-invalid' : '' }}"
                                              name="MarketingComments" tabindex=14 @if(!empty($productdata['MarketingComments'])) value="{{ $productdata['MarketingComments'] }}"
                                               @else value="{{ old('MarketingComments') }}" @endif placeholder="Catalog and eCommerce Product Description"></textarea>
