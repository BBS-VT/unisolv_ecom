            ...
            <div class="card">
                        ...
                        <div class="col">
                            <div class="row">
                                ...
                                @if($customer->IsOnCreditHold==1)
                                    <span class="badge bg-warning text-dark">{{ __('global.credit_hold') }}</span>
                                @endif
                                &nbsp;&nbsp;
                ...
                <div class="card-body">
                    <ul class="nav-border nav nav-pills mb-0" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" data-bs-toggle="tab" href="#home" role="tab" aria-selected="true">{{ __('global.detail') }}</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" data-bs-toggle="tab" href="#contacts" role="tab" aria-selected="true">{{ __('global.contacts') }}</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" data-bs-toggle="tab" href="#orders" role="tab" aria-selected="true">{{ __('global.orders') }}</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" data-bs-toggle="tab" href="#notes" role="tab" aria-selected="true">{{ __('global.notes') }}</a>
                        </li>
                    </ul>
