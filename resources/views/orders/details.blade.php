                            ...
                            <div class="table-responsive project-invoice">
                                <table class="table table-bordered mb-0">
                                    ...
                                    <tr >
                                        ...
                                        <td class="border-0 font-14 text-dark text-right"><b>{{ number_format($order->getSubTotalAmountIncl() / 1000, 2, ".", " ") }}</b></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr class="bg-black text-white">
                                        ...
                                        <td class="border-0 font-14 text-right"><b>{{ number_format($order->getSubTotalAmountIncl() / 1000, 2, ".", " ") }}</b></td>
                                    </tr>
                                    </tbody>
                                </table>
                            </div>
