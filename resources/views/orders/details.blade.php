                ...
                <div class="tm_invoice_in">
                    ...
                    <div class="tm_invoice_info tm_mb20">
                        ...
                        <div class="tm_invoice_info_list">
                            <p class="tm_invoice_number tm_m0">Order No: <b class="tm_primary_color">{{ $order->OrderNumber }}</b></p>
                    ...
                    <div class="tm_invoice_head tm_mb10">
                        <div class="tm_invoice_left">
                            ...
                            <p>
                                ...
                                {{ $order->customer->PhoneNumber }} | {{ $order->customer->GeneralEmailAddress }} <br>
                                VAT nr: {{ $order->customer->VATNumber ?? 'N/A' }}
                            </p>
                        </div>
                        <div class="tm_invoice_right tm_text_right">
